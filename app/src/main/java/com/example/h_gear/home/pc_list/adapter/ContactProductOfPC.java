...
public class ContactProductOfPC {
    private String name;
    ...
    public ContactProductOfPC() {
    }

    public ContactProductOfPC(String name, String oldPrice, String disCount, String intelCore, String nvidiaGeforce, String monitor, String ssd, String ram, String image) {
        this.name = name;
