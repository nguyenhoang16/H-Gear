package com.example.h_gear.home.details;
...
public class DetailsLapTopFragment extends Fragment implements ISQLHelper {
    ...
    public static DetailsLapTopFragment newInstance() {
        
        Bundle args = new Bundle();
        
        DetailsLapTopFragment fragment = new DetailsLapTopFragment();
    ...
    public void getContactProduct(ContactProduct con){
        name = con.getName();
