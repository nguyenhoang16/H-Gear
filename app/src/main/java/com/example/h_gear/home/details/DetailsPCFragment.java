...
public class DetailsPCFragment extends Fragment implements ISQLHelper {
    ...
    public static DetailsPCFragment newInstance() {
        Bundle args = new Bundle();

        DetailsPCFragment fragment = new DetailsPCFragment();
